    ...
    <main className="min-h-screen flex items-center justify-center p-6">
      <div className="w-full max-w-md rounded-2xl border border-white/10 bg-white/5 backdrop-blur p-8 text-white space-y-6">
        <div className="text-center space-y-2">
          ...
          <p className="text-sm text-white/70">Start journaling with Mood Journal AI</p>
        </div>
        ...
        <p className="text-center text-sm text-white/60">
          ...
          <ButtonLink href="/login" size="sm" variant="secondary" className="px-4 py-2 rounded-full">
            Sign in
          </ButtonLink>
        </p>
