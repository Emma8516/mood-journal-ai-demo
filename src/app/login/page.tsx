        ...
        <div className="w-full max-w-md rounded-2xl border border-white/10 bg-white/5 backdrop-blur p-8 text-white space-y-6">
          ...
          >
            <svg width="18" height="18" viewBox="0 0 48 48" aria-hidden>
              <path fill="#FFC107" d="M43.6 20.5H42V20H24v8h11.3C33.6 32.2 29.2 36 24 36c-6.6 0-12-5.4-12-12s5.4-12 12-12c3 0 5.7 1.1 7.8 3l5.7-5.7C34.3 6.3 29.4 4 24 4 12 4 9.1 8.6 6.3 14.7z"/>
          ...
          <p className="text-center text-sm text-white/60">
            ...
            <ButtonLink href="/register" className="px-4 py-2 text-sm rounded-full">
              Create account
            </ButtonLink>
          </p>
        </div>
